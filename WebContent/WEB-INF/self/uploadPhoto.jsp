			...
			<div class="info_left">
				<table width="100%" border="0" cellspacing="1" cellpadding="10">
					<tr>
						<td valign="top">
							<div class="divTbl">
								<table width="100%" border="0" cellspacing="1" cellpadding="10"
									...
									<tr>
										<td>
											<form action="/Renren/profile.do?flag=uploadPhoto" method="post"
												...
												<table width="100%" border="0" cellspacing="1"
													...
													<tr>
														<td valign="top">
															...
															<br />
															<img src="/Renren/images/${loginuser.id}/head/${loginuser.photo}?abc=<%=Math.random()%>" width="200"
																height="200" />
														</td>
														<td valign="top">
															&nbsp;
															...
															<br />
															&nbsp;
															<input type="file" class="wby" name="headphoto" />
															<br />
															&nbsp;
						...
						<td align="center">
							<img src="/Renren/images/front/selfright.jpg" />
						</td>
					</tr>
				</table>
