...
<html>
  <head> 
    <title>校内用户注册</title>
    <link rel="stylesheet" type="text/css" href="/Renren/css/common.css"/>
	<link rel="stylesheet" type="text/css" href="/Renren/css/register.css"/>
 	<script type="text/javascript" src="/Renren/js/jquery-1.3.1.js"></script>
 	<script type="text/javascript" src="/Renren/js/publicJs.js"></script>
 	<script type="text/javascript" src="/Renren/myAJAX/ajax_uni.js"></script>
  </head>
   ...
   <!-- 加入校内后，可以选择... -->
   <div class="play_item">
   <img src="/Renren/images/front/jiaru.jpg" />
   </div>
   <!-- 注册用的表格 -->
   <div class="reg_table1">
   <span class="font6">简单一步，快速注册</span><br/>
   <form action="/Renren/register.do?flag=regUser" method="post">
   <table>
   <tr>
	   <td class="tab_td1">真实姓名:</td>
	   <td class="tab_td2"><input type="text" name="name"/></td>
	   <td>
		   <span class="spanVal">请输入真实姓名</span>
	   </td>
   </tr>
   <tr>
   ...
   <tr class="gra_sep">
	   ...
	   <td class="tab_td2">
		   ...
		   <input id="university" onclick="showRegUni();" type="text" name="" />
	   </td>
	   <td></td>
   </tr>
   ...
   <tr class="worker_sep">
	   ...
	   <td class="tab_td2"><input type="input" name="??" /></td>
	   <td></td>
   </tr>  
   ...
   <img src="/Renren/images/front/tanhao.png" />如果没有邮箱，请注册<a href="#">Hotmail</a>邮箱。
   </td>
   <td></td>
   </tr>
   <tr>
